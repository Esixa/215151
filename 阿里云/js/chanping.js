window.onload=function(){
 ...
 var qop1=document.getElementById('menu1').getElementsByClassName('qop');
 var qop2=document.getElementById('menu2').getElementsByClassName('qop');
 var qop3=document.getElementById('menu3').getElementsByClassName('qop');
  var qopq1=document.getElementById('menu1').getElementsByClassName('qopq');
 var qopq2=document.getElementById('menu2').getElementsByClassName('qopq');
 var qopq3=document.getElementById('menu3').getElementsByClassName('qopq');
  ...
  for(var n=0;n<menu1.length;n++){
      ...
      menu1[n].onclick=function(){
        for(var j=0;j<open_menu1.length;j++){
            ...
            qopq1[j].style.display='none';
            qopq2[j].style.display='none';
            qop1[j].style.display='block';
            qop2[j].style.display='block';
         ...
         for(var i=0;i<open_menu3.length;i++){
            ...
            qopq3[i].style.display='none';
            qop3[i].style.display='block';
         ...
         qopq1[this.index].style.display='block';
         qop1[this.index].style.display='none';
  ...
  for(var m=0;m<menu2.length;m++){
      ...
      menu2[m].onclick=function(){
        ...
        qopq2[this.index].style.display='block';
         qop2[this.index].style.display='none';
        ...
        for(var j=0;j<open_menu3.length;j++){
         ...
         sanjiao3[this.index].style.display='block';
          menu3[this.index].style.color='#00c1de';
            qopq3[this.index].style.display='block';
         qop3[this.index].style.display='none';
